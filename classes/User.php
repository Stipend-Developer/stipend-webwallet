...
class User {
	...
	//	global $hide_ids;
		...
		if (($id))
		{
			$msg = "<center> Secret Key: $secret <br>*Please write this down and keep in a secure area*<br><br><img src='$qrcode'<br><br><br>Please scan this with the Google Authenticator app on your mobile phone. <br>This page will clear on refresh, please be careful.<br><br></center>";
      ...
      function disauth()
    		  ...
    		  if (($id))
     		 {
			$msg = "<center> Two Factor Auth has been disabled for your account and will no longer be required when you sign in.<br><br></center>";
